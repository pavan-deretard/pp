...
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/pipelined {C:/intelFPGA_lite/pipelined/program_counter.v}

vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/pipelined {C:/intelFPGA_lite/pipelined/pp.v}
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/pipelined {C:/intelFPGA_lite/pipelined/decode.v}
vlog -vlog01compat -work work +incdir+C:/intelFPGA_lite/pipelined {C:/intelFPGA_lite/pipelined/read.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L fiftyfivenm_ver -L rtl_work -L work -voptargs="+acc"  prog_cache
